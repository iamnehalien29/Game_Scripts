...
Last updated: Fri May 22 14:11:35 UTC 2026

Tracked 43 games across 3 languages.
...
### 🎯 [GuessingNumber](./Javascript/GuessingNumber/)
A fun game built with core programming concepts
...
### 🎯 [SimplePlatformer](./Javascript/SimplePlatformer/)
🎮 Simple Platformer Game

### 🎯 [Snake Game](./Javascript/Snake Game/)
...
### 🎯 [Dots_Boxes](./Python/Dots_Boxes/)
A fun game built with core programming concepts

### 🎯 [Dungeon_escape](./Python/Dungeon_escape/)
A console-based maze adventure!

### 🎯 [Guess_the_number](./Python/Guess_the_number/)
A fun console-based game where you try to guess the number chosen by the computer!

### 🎯 [Hangman](./Python/Hangman/)
- Language: Python

### 🎯 [math_rush](./Python/math_rush/)
Language: Python

### 🎯 [Maze_Runner](./Python/Maze_Runner/)
A fun game built with core programming concepts

### 🎯 [Memory_Flip](./Python/Memory_Flip/)
A simple GUI memory game built with Tkinter.

### 🎯 [Platformer](./Python/Platformer/)
- Language: Python

### 🎯 [Pong_game](./Python/Pong_game/)
...
### 🎯 [rock_paper_scissors](./Python/rock_paper_scissors/)
